...
$itemcur = App\Models\Accueilprojetitem::find($slug);
$listContent = $itemcur->contentViews;//->leftJoin("content_view_types", "content_views.content_view_type_id", "=", "content_view_types.id");
...
<head>
    ...
    <title>{{ $itemcur?->title.' | '.$setting->nom_site }}</title>
