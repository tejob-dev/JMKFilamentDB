...
use App\Filament\Resources\GallerieResource\Pages;

class GallerieResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateGallerie::route('/create'),
            'view' => Pages\ViewGallerie::route('/{record}'),
            'edit' => Pages\EditGallerie::route('/{record}/edit'),
        ];
    }
}
