...
use App\Filament\Resources\AccueilserviceResource\Pages;
...
class AccueilserviceResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->poll('60s')
            ->columns([
                Tables\Columns\TextColumn::make('secton')
                    ->toggleable()
    ...
    {
        return [
            AccueilserviceResource\RelationManagers\AccueilserviceitemsRelationManager::class,
        ];
    }
    ...
    {
        return [
            'index' => Pages\ListAccueilservices::route('/'),
            'create' => Pages\CreateAccueilservice::route('/create'),
            'view' => Pages\ViewAccueilservice::route('/{record}'),
            'edit' => Pages\EditAccueilservice::route('/{record}/edit'),
        ];
    }
}
