...
class AccueilclientitemResource extends Resource
{
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('image')
                    ->toggleable()
                    ->circular(),
                Tables\Columns\TextColumn::make('accueilclient.title')
                    ->toggleable()
                    ->limit(50),
            ])
            ->filters([
                ...
                SelectFilter::make('accueilclient_id')
                    ->relationship('accueilclient', 'title')
                    ->indicator('Accueilclient')
                    ->multiple()
                    ->label('Accueilclient'),
            ]);
    }
    ...
    {
        return [
            'index' => Pages\ListAccueilclientitems::route('/'),
            'create' => Pages\CreateAccueilclientitem::route('/create'),
            'view' => Pages\ViewAccueilclientitem::route('/{record}'),
            'edit' => Pages\EditAccueilclientitem::route('/{record}/edit'),
        ];
    }
}
