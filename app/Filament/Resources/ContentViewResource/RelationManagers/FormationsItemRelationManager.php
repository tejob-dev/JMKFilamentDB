...
class FormationsItemRelationManager extends RelationManager
{

    protected static ?string $label = 'Lier une formation et son contenu';

    protected static ?string $title = 'Lier une formation et son contenu';
