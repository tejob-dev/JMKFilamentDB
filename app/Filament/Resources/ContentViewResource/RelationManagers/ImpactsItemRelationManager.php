...
class ImpactsItemRelationManager extends RelationManager
{

    protected static ?string $label = 'Lier un impact et son contenu';

    protected static ?string $title = 'Lier un impact et son contenu';
