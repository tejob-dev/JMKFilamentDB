...
class ManagersItemRelationManager extends RelationManager
{

    protected static ?string $label = 'Lier un manager et son contenu';

    protected static ?string $title = 'Lier un manager et son contenu';

    protected static string $relationship = 'accueilmanageritems';
    
    // protected static ?string $model = Accueilmanageritem::class;
            ...
            Grid::make(['default' => 0])->schema([
                    ...
                    Forms\Components\Select::make('content_viewable_id')
                        ...
                        ->options(function (callable $get) {
                            ...
                            return Accueilmanageritem::all()->pluck('title', 'id')->toArray();
                        })
                        ->columnSpan([
                            'default' => 12,
                            'md' => 12,
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('content_viewable_id')
                    ->label('Manager')
                    ->getStateUsing(fn ($record) => Accueilmanageritem::find($record->content_viewable_id)?->title)
                    ->sortable()
                    ->searchable(),
            ])
            ->filters([
            ...
            ->headerActions([
                ...
                ->using(function (HasRelationshipTable $livewire, array $data): Model {
                    $dataf = $data;
                    $dataf["content_viewable_type"] = strval(Accueilmanageritem::class);
                    // dd($dataf);
