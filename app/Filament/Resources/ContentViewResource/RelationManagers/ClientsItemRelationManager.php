...
class ClientsItemRelationManager extends RelationManager
{

    protected static ?string $label = 'Lier un client et son contenu';

    protected static ?string $title = 'Lier un client et son contenu';
