...
class ProjetsItemRelationManager extends RelationManager
{

    protected static ?string $label = 'Lier un projet et son contenu';

    protected static ?string $title = 'Lier un projet et son contenu';

    protected static string $relationship = 'accueilprojetitems';
