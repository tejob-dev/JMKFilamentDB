...
namespace App\Filament\Resources\AccueilmanagerResource\RelationManagers;
...
class AccueilmanageritemsRelationManager extends RelationManager
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('accueilmanager.title')->limit(
                    50
                ),
            ])
            ->filters([
                ...
                MultiSelectFilter::make('accueilmanager_id')->relationship(
                    'accueilmanager',
                    'title'
                ),
            ])
