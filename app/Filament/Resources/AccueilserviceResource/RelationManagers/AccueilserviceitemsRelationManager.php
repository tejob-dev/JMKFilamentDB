...
namespace App\Filament\Resources\AccueilserviceResource\RelationManagers;
...
class AccueilserviceitemsRelationManager extends RelationManager
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('subservice')->limit(50),
                Tables\Columns\TextColumn::make('boutontitre')->limit(50),
                Tables\Columns\TextColumn::make('boutonlien')->limit(50),
                Tables\Columns\TextColumn::make('accueilservice.title')->limit(
                    50
                ),
            ])
            ->filters([
                ...
                MultiSelectFilter::make('accueilservice_id')->relationship(
                    'accueilservice',
                    'title'
                ),
            ])
