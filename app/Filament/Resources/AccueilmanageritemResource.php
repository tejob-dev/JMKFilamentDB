...
class AccueilmanageritemResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                SelectFilter::make('accueilmanager_id')
                    ->relationship('accueilmanager', 'title')
                    ->indicator('Accueilmanager')
                    ->multiple()
                    ->label('Accueilmanager'),
            ]);
    }
    ...
    {
        return [
            'index' => Pages\ListAccueilmanageritems::route('/'),
            'create' => Pages\CreateAccueilmanageritem::route('/create'),
            'view' => Pages\ViewAccueilmanageritem::route('/{record}'),
            'edit' => Pages\EditAccueilmanageritem::route('/{record}/edit'),
        ];
    }
}
